...
pub mod notification_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn send_notification(
            ...
            tonic::Response<super::NotificationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("notification.Notification", "sendNotification"),
                );
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/notification.Notification/sendNotification" => {
                    ...
                    struct sendNotificationSvc<T: Notification>(pub Arc<T>);
                    impl<
                        T: Notification,
                    > tonic::server::UnaryService<super::NotificationRequest>
                    for sendNotificationSvc<T> {
                        type Response = super::NotificationResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Notification>::send_notification(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
